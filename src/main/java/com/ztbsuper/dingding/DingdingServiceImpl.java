...
public class DingdingServiceImpl implements DingdingService {
    ...
    public DingdingServiceImpl(String jenkinsURL, String token, String customSuccessMessage,boolean onStart, boolean onSuccess, boolean onFailed, boolean onAbort, TaskListener listener, AbstractBuild build) {
    ...
    public void success() {
		...
		String changes = "";
		 try {
            changes = build.getEnvironment(listener).expand("$SCM_CHANGELOG");
            	if (changes.equals("$SCM_CHANGELOG")){
					changes = "";
		        }else{
		        changes += "\n";
		        }
