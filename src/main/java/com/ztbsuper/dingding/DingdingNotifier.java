...
public class DingdingNotifier extends Notifier {
    ...
    public DingdingNotifier(String accessToken, String customSuccessMessage, boolean onStart, boolean onSuccess, boolean onFailed, boolean onAbort, String jenkinsURL) {
        super();
    ...
    public DingdingService newDingdingService(AbstractBuild build, TaskListener listener) {
        return new DingdingServiceImpl(jenkinsURL, accessToken, customSuccessMessage,onStart, onSuccess, onFailed, onAbort, listener, build);
    }
